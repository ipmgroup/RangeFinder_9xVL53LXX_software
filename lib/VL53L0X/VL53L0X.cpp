...
VL53L0X::VL53L0X(uint8_t _address = ADDRESS_DEFAULT)
        : RangeSensor(_address)
...
bool VL53L0X::init(bool io_2v8)
{
        ...
        // // reset device
        // writeReg(VL53L0X_REG_SOFT_RESET_GO2_SOFT_RESET_N, 0x00);
        // //while (readReg(VL53L0X_REG_IDENTIFICATION_REVISION_ID) != 0x00);
        // delay(100);
        // writeReg(VL53L0X_REG_SOFT_RESET_GO2_SOFT_RESET_N, 0x01);
        // //while (readReg(VL53L0X_REG_IDENTIFICATION_REVISION_ID) != 0x00);
        // delay(100);
        // RangeSensor::address = ADDRESS_DEFAULT;
