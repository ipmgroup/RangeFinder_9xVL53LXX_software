...
typedef struct __mavlink_distance_sensor_t {
 ...
 uint8_t covariance; /*< [cm^2] Measurement variance. Max standard deviation is 6cm. 256 if unknown.*/
 ...
 * @param covariance [cm^2] Measurement variance. Max standard deviation is 6cm. 256 if unknown.
 ...
 *
 * @return [cm^2] Measurement variance. Max standard deviation is 6cm. 256 if unknown.
 */
